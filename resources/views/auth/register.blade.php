<x-guest-layout>
    <x-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mt-4">
                <x-label for="phone" value="{{ __('Telephone number') }}" />
                <x-input id="phone" class="block w-full mt-1" type="text" name="phone" :value="old('phone')" autocomplete="username" />
            </div>

            {{-- <div class="mt-4">
                <x-label for="address" value="{{ __('Contact Address') }}" />
                <textarea id="address" class="block w-full mt-1" name="address" :value="old('address')" autocomplete="username">
                </textarea>
            </div> --}}
